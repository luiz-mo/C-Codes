...
Para as funções gbv_remove e gbv_view, não consegui fazer usando a assinatura original do gbv.h fornecido e para ambas, incluí como argumento o nome da biblioteca. Na questão do gbv_view, considero que também enfrentei dificuldades, pois pensei demais no tamanho dos blocos não ser fixo, por exemplo, um documento com 2100 bytes com blocos de 1024 bytes teria dois blocos de 1024B e outro de 52B. Porém, vi que o jeito que eu estava tentando fazer não iria funcionar para dois 'p' seguidos, então adotei que os blocos voltam com tamanho fixo e não com o tamanho do bloco atual.
